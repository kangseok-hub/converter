      ...
      <main className="max-w-6xl mx-auto px-4 py-8 space-y-8">
        ...
        <section className="bg-white p-6 md:p-8 rounded-3xl shadow-sm border border-slate-200/70 space-y-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
            ...
            {/* 향후 학기별 예상 등급 */}
            <div className="lg:col-span-7 bg-indigo-50/40 p-5 rounded-2xl border border-indigo-100/70 space-y-3">
              <div className="flex justify-between items-center">
                <div className="flex items-center gap-1.5">
                  <Sparkles className="w-4 h-4 text-indigo-600" />
                  <span className="text-xs font-black text-slate-800">향후 학기별 예상 등급 (5등급제)</span>
                </div>
                <button
              ...
              <p className="text-[11px] text-slate-500">
                빈칸으로 둔 학기는 <span className="font-bold text-indigo-600">현재 성적({gpa5.toFixed(2)})</span>으로 자동 반영됩니다.
              </p>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5 pt-1">
                {[
                  ...
                  return (
                    <div key={key} className="bg-white p-2.5 rounded-xl border border-indigo-100 text-center space-y-1">
                      ...
                      <input
                        ...
                        className={`w-full py-1 text-center text-base font-black rounded-lg border outline-none ${
                          val !== '' ? 'bg-indigo-50 border-indigo-500 text-indigo-700' : 'border-slate-200 text-slate-400 placeholder:text-slate-300'
                        }`}
                      />
                    </div>
                  );
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
              <div className="flex flex-wrap items-center gap-2">
                <span className="px-2.5 py-1 bg-indigo-50 text-indigo-700 text-xs font-black rounded-lg border border-indigo-100">
                  {useProjectedGrade ? '예상 최종 성적 기준' : '현재 성적 기준'}
                </span>
